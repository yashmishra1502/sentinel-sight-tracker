  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-navbar/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
        ...
        <Link
          to="/login"
          className="hidden min-h-10 shrink-0 items-center rounded-md border border-border px-3 text-sm font-semibold text-foreground transition-colors hover:bg-accent sm:inline-flex"
        >
          Login
        </Link>
        <Link
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.15fr] lg:items-center">
          <div className="min-w-0">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                to="/login"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-royal px-6 text-sm font-bold tracking-wide text-royal uppercase transition-colors hover:bg-royal/10"
              >
                Officer Login
              </Link>
            </div>
